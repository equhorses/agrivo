        ...
        <div className="container max-w-7xl">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm">Vista general de Camplis, al minuto</p>
            </div>
          </div>
      ...
      <Dialog open={!!messageTarget} onOpenChange={(open) => !open && setMessageTarget(null)}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Le llegará como "Equipo Camplis" en su bandeja de Mensajes, y le avisa una notificación.
            </DialogDescription>
          </DialogHeader>
          <Textarea
            value={messageDraft}
