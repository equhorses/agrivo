    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 py-12 bg-slate-50">
        <div className="max-w-3xl mx-auto px-4">
          <h1 className="text-2xl md:text-3xl mb-6" style={{ fontFamily: 'Poppins, sans-serif' }}>Panel de analíticas</h1>
          ...
          {loading ? (
            ...
            <Card className="bg-white">
              <CardContent className="p-10 text-center">
                ...
                <h3 className="text-lg font-medium mb-2">Solo para el plan Empresa</h3>
                <p className="text-muted-foreground mb-6">
                  El panel de analíticas (rendimiento de tus ofertas, reseñas y mensajes) es un beneficio
                  del plan Empresa.
                </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Card className="bg-white">
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm text-muted-foreground flex items-center gap-2">
                    <Star className="h-4 w-4 text-amber-500" />Valoración
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">{reviewCount} {reviewCount === 1 ? 'reseña' : 'reseñas'}</p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white">
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm text-muted-foreground flex items-center gap-2">
                    <Briefcase className="h-4 w-4 text-emerald-600" />Trabajos completados
                  </CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card className="bg-white">
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm text-muted-foreground flex items-center gap-2">
                    <TrendingUp className="h-4 w-4 text-emerald-600" />Tasa de éxito en ofertas
                  </CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card className="bg-white">
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm text-muted-foreground flex items-center gap-2">
                    <MessageSquare className="h-4 w-4 text-emerald-600" />Mensajes
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-3xl font-bold" style={{ fontFamily: 'Poppins, sans-serif' }}>{messageCount}</p>
                  <p className="text-xs text-muted-foreground mt-1">enviados y recibidos en total</p>
                </CardContent>
              </Card>
            </div>
          )}
