...
FROM_EMAIL = "Camplis <notifications@camplis.app>"
...
def kyc_approved_email(full_name: str, plan: str) -> tuple[str, str]:
    ...
    <div style="font-family: 'Segoe UI', sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="text-align: center; padding: 30px 0;">
            <h1 style="color: #166534; margin: 0;">🌱 Camplis</h1>
        ...
        <div style="text-align: center; padding: 20px;">
            <a href="https://agrivo-two.vercel.app/dashboard" style="background: #166534; color: white; padding: 12px 30px; border-radius: 8px; text-decoration: none; font-weight: 600;">
                Ver mi perfil
            </a>
        </div>
...
def kyc_rejected_email(full_name: str, reason: str = "") -> tuple[str, str]:
    ...
    <div style="font-family: 'Segoe UI', sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="text-align: center; padding: 20px;">
            <a href="https://agrivo-two.vercel.app/kyc" style="background: #166534; color: white; padding: 12px 30px; border-radius: 8px; text-decoration: none; font-weight: 600;">
...
def new_message_email(sender_name: str) -> tuple[str, str]:
    ...
    subject = f"💬 Nuevo mensaje de {sender_name} en Camplis"
    html = f"""
    <div style="font-family: 'Segoe UI', sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="text-align: center; padding: 30px 0;">
            <h1 style="color: #166534; margin: 0;">🌱 Camplis</h1>
        ...
        <div style="text-align: center; padding: 20px;">
            <a href="https://agrivo-two.vercel.app/messages" style="background: #166534; color: white; padding: 12px 30px; border-radius: 8px; text-decoration: none; font-weight: 600;">
                Leer mensaje
            </a>
        </div>
    </div>
