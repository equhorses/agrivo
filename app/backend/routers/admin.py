...
async def get_dashboard(
    ...
    """Vista general de Camplis, al minuto — la pestaña 'Resumen' del panel."""
...
async def assign_staff_role(
    ...
    existente — la persona debe haberse registrado antes en Camplis."""
...
async def cancel_bid_admin(
    ...
    # Avisar a quien pujó — viene del equipo de Camplis, no del dueño del
    ...
    db.add(Notifications(
        ...
        body="El equipo de Camplis ha anulado esta oferta. Si crees que es un error, contáctanos.",
...
async def send_message_admin(
    ...
    """El equipo de Camplis escribe primero a un usuario (no moderar una
    conversación ya existente, sino arrancar una). Aparece de cara al
    usuario como "Equipo Camplis", y le llega notificación."""
    ...
    db.add(Notifications(
        ...
        type="admin_message",
        title="Tienes un mensaje del equipo de Camplis",
